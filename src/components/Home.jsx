  ...
  return (
    <div className='w-full font-poppins max-w-screen-2xl mx-auto'>
        <div className="md:flex md:items-start md:justify-center md:w-full md:px-7">
           ...
           className="hidden md:flex fixed bottom-0 left-7 lg:left-12 xl:left-16 flex-col items-start justify-end z-20">
           ...
           <motion.div
             ...
             initial={{ opacity: 1, scale: 1 }}
           className="hidden md:flex fixed bottom-0 right-7 lg:right-12 xl:right-16 flex-col items-center justify-end z-20">
